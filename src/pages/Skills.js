			...
			<Layout>
				...
				<div className='skills-landing' ref={skillsRef}>
					...
					<div className='skills-landing__box2' id='skillsP'>
						...
						<p>
							<b> Technical SEO </b>is also essential for a complete
							achievement.
						</p>
						<p>
						...
						<p>
							On the <b> Server Side</b>, I used PHP and SQL at the beginning
							but I really enjoyed working with Node.js and Mongo DB to build my
							own REST API.
						</p>
					</div>
				</div>
